<aside class="col-lg-3 bg-white">
            ...
            <article class="list-group mb-2">
                <a href="<?=  get_permalink($post->ID); ?>" class="list-group-item list-group-item-action flex-column align-items-start home-comunicados-card">
                    <div class="d-flex w-100 justify-content-between pl-0">
                        ...
                        <small class="d-xl-inline float-right m-0 d-lg-none d-md-none d-sm-inline badge"><i class="fa fa-clock-o"></i> <?= get_the_date("d F Y", $post->ID);?></small>                  
                    </div>
    ...
    <section class="home-asider-clipagem">
        <header class="home-aside-clipagem-header text-center"> <a href="<?= CLIPAGEMDIGITAL_URI ?>" class="text-white" target="_blank"> <i class="fa fa-paperclip m-auto text-white float-left" style="position: relative; left:20px; top:8px"></i> CMSJ na Mídia </a></header>
        <?php 
        ...
        <div class="mt-2">
            ...
            <article class="list-group mb-2">
                <a href="http://clipagem.cmsj.info/uploads/<?= $clipagem['nome'] ?>" target="_blank" class="list-group-item list-group-item-action flex-column align-items-start home-clipagem-card">                        
                    ...
                    <small class="d-xl-inline m-0 d-lg-none d-md-none d-sm-inline badge badge-secondary rounded-0 col-lg-12"> <i class="fa fa-clock-o"></i> <?= $clipagem['data'] ?></small>     
